...
- **Catalogue folders** — `Catalogue.list_folder_tree/1`, `move_folder/3`, `move_catalogue_to_folder/3` etc. drive the Finder-style tree on the index page; soft-delete only.
